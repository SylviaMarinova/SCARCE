...
#Read the excel file with the idicators data, iterate over each Excel sheet and appends it to a separate dictionary
...
supply_risk_scaled_final.to_csv(
    'E:/untitled folder/Python/Results/Supply risk/Supply risk scaled_global.csv', index = True
    )
social_standard_final.to_csv(
    'E:/untitled folder/Python/Results/Social standards/Compliance with social standards_global.csv', index = True
    )
environmental_standard_final.to_csv(
    'E:/untitled folder/Python/Results/Environmental standards/Compliance with environmental standards_global.csv', index = True
    )

#%%Export the results with total column

supply_risk_scaled_final_total.to_csv(
    'E:/untitled folder/Python/Results/Supply risk/Supply risk total_global.csv', index = True
    )
social_standard_final_total.to_csv(
    'E:/untitled folder/Python/Results/Social standards/Compliance with social standards total_global.csv', index = True
    )
environmental_standard_final_total.to_csv(
    'E:/untitled folder/Python/Results/Environmental standards/Compliance with environmental standards total_global.csv', index = True
    )
...
# Save the graph
supply_risk.get_figure().savefig('E:/untitled folder/Python/Results/Sypply risk_global.png', dpi=300)
...
# Save the graph
social_standard.get_figure().savefig('E:/untitled folder/Python/Results/Social standard_global.png', dpi=300)
...
# Save the graph
environmental_standard.get_figure().savefig('E:/untitled folder/Python/Results/Environmental standard_global.png', dpi=300)

############## PLOT THE CRITICALITY MATRIX ################

results = pd.read_csv(
    'E:/untitled folder/Python/Results/Result_total_global.csv'
    )
